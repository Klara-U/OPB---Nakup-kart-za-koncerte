...
# za vhodni dataclass vrne seznam objektov iz baze
...
# vrne dataclass objekt iz baze na podlagi id-ja
...
# v bazo doda entiteto/objekt, nastavimo tudi serial, če je definiran
        ...
        # v bazo zapiše seznam objektov/entitet
        ...
        # pomožna funkcija, niz spremeni v camel case zapis    
